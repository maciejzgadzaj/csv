...
Call theme('csv', ...) function the same way as you call theme('table', ...).

  theme_csv($header, $rows, $attributes = array(), $caption = NULL,
            $delimiter = CSV_DELIMITER, $enclosure = CSV_ENCLOSURE)
